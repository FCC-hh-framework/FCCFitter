...
python python/limitplot.py -f "Outputs/fcc_v02/Zprime/ee/Zprime_ee_*TeV/Limits/*" -n "Zprime_ee_fcc_v02" -p "Z\' \rightarrow e^+e^-" -s "p8_pp_ZprimeSSM_VALUETeV_ll"
python python/limitplot.py -f "Outputs/fcc_v02/Zprime/ll/Zprime_ll*TeV/Limits/*" -n "Zprime_ll_fcc_v02" -p "Z\' \rightarrow l^+l^-\ (l=e,\mu)" -s "p8_pp_ZprimeSSM_VALUETeV_ll"
...
python python/limitplot.py -f "Outputs/fcc_v02/Zprime/ee/Zprime_ee_*TeV/Limits/*" -n "Zprime_ee_fcc_v02_allxs" -p "Z\' \rightarrow e^+e^-" -s "p8_pp_ZprimeSSM_VALUETeV_ll" -m "p8_pp_ZprimeCHI_VALUETeV_ll p8_pp_ZprimePSI_VALUETeV_ll p8_pp_ZprimeI_VALUETeV_ll p8_pp_ZprimeETA_VALUETeV_ll p8_pp_ZprimeLRM_VALUETeV_ll"
python python/limitplot.py -f "Outputs/fcc_v02/Zprime/ll/Zprime_ll*TeV/Limits/*" -n "Zprime_ll_fcc_v02_allxs" -p "Z\' \rightarrow l^+l^-\ (l=e,\mu)" -s "p8_pp_ZprimeSSM_VALUETeV_ll" -m "p8_pp_ZprimeCHI_VALUETeV_ll p8_pp_ZprimePSI_VALUETeV_ll p8_pp_ZprimeI_VALUETeV_ll p8_pp_ZprimeETA_VALUETeV_ll p8_pp_ZprimeLRM_VALUETeV_ll"

python python/limitplot.py -f "Outputs/fcc_v02/Zprime_ano/mumu/Zprime_mumu_*TeV/Limits/*" -n "Zprime_mumu_ano_fcc_v02" -p "Z\' \rightarrow \mu^+\mu^- (1710.06363)" -s "mgp8_pp_Zprime_mumu_5f_Mzp_VALUETeV"
